        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-6 md:p-8 shadow-xl border border-white/40">
          ...
          <div className="mb-8 flex items-center justify-center gap-4">
            ...
            <div className={`flex items-center gap-2 ${currentStep === 'form' ? 'text-blue-600' : 'text-slate-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold ${currentStep === 'form' ? 'bg-blue-600 text-white' : 'bg-slate-300 text-slate-600'}`}>
                2
              </div>
                ...
                <div className="border-2 border-dashed border-slate-300 rounded-xl p-12 text-center hover:border-blue-400 transition-colors">
                  ...
                  <label htmlFor="image-upload" className="cursor-pointer flex flex-col items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500 mt-2">Maksimal 5MB (.jpg, .jpeg, .png, .webp)</p>
                    </div>
                  </label>
                </div>
              ) : (
