      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-3xl overflow-hidden shadow-xl border border-white/40 mb-8">
          ...
          <div className="p-6 md:p-8">
            ...
            {recipe.description && (
              <p className="text-slate-600 text-lg mb-6 leading-relaxed">{recipe.description}</p>
            )}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-white/70 backdrop-blur p-4 rounded-xl border border-white/60 text-center">
                ...
                <p
                  className={`font-semibold capitalize ${getDifficultyColor(recipe.difficulty)}`}
                >
                  {recipe.difficulty}
                </p>
              </div>
            ...
            {recipe.average_rating > 0 && (
              <div className="mt-6 flex items-center gap-4 bg-amber-50 border border-amber-200 rounded-xl p-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">{recipe.review_count} ulasan</p>
                </div>
              </div>
            )}
          </div>
            ...
            <ol className="space-y-4">
              {recipe.steps?.map((step) => (
                ...
                >
                  ...
                  <p className="text-slate-700 leading-relaxed pt-1">{step.instruction}</p>
                </li>
              ))}
            </ol>
          </div>
